...
gcloud run deploy glasswake-kanon-pulse \
  ...
  --max-instances 1 \
  --set-env-vars "GLASSWAKE_STORE=firestore,GLASSWAKE_GEMINI_MODEL=gemini-3.7-flash,GOOGLE_GENAI_USE_VERTEXAI=true,GOOGLE_CLOUD_PROJECT=${KANON_PULSE_GCP_PROJECT},GOOGLE_CLOUD_LOCATION=global"
